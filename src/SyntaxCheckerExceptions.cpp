...
//           :      _/|      :       Last Edit  : 2015-07-08 08:40:01
//            :   =/_/      :        Author     : nsierra-
...
SyntaxCheckerException::SyntaxCheckerException(SyntaxCheckerException const & src) { *this = src; }
...
const char *	SyntaxCheckerException::what() const throw() { return "Syntax Checker Exception (You should not see this)";}


NoEndTokenException::NoEndTokenException() {}
NoEndTokenException::NoEndTokenException(NoEndTokenException const & src) { *this = src; }
NoEndTokenException::~NoEndTokenException(void) throw() {}
const char *	NoEndTokenException::what() const throw() { return "End of program token (;;) not found.";}


NeedlessEndTokenException::NeedlessEndTokenException() {}
NeedlessEndTokenException::NeedlessEndTokenException(NeedlessEndTokenException const & src) { *this = src; }
NeedlessEndTokenException::~NeedlessEndTokenException(void) throw() {}
const char *	NeedlessEndTokenException::what() const throw() { return "Superfluous end of program token (;;) found. Use it only when using avm with stdin.";}


InvalidInstructionException::InvalidInstructionException() {}
InvalidInstructionException::InvalidInstructionException(InvalidInstructionException const & src) { *this = src; }
...
InvalidValueException::InvalidValueException(InvalidValueException const & src) { *this = src; }
...
FileOpeningFailException::FileOpeningFailException(FileOpeningFailException const & src) { *this = src; }
...
EmptyProgramException::EmptyProgramException(EmptyProgramException const & src) { *this = src; }
